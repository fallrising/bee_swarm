    ...
    def product_manager_process(self):
        ...
        while True:
            ...
            if new_issues:
                ...
                # 创建开发任务
                self.create_development_tasks(issue)
            ...
            # 生成日报
            if self.env.now % 24 < 1:
                self.generate_daily_report(role_id)
